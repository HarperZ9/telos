...
| --- | --- | --- |
| A production Telos research corpus must preserve source identity, rights posture, and provenance before full-text use. | doc-and-research-receipt-check | C:/dev/public/telos/docs/CURRENT-STATE.md records Gather research receipts and source labels.; C:/dev/public/portfolio-site/docs/superpowers/research/2026-06-28-project-telos-current-state-and-research-os.md records rights-clean metadata spine and full-text boundaries.; local-download:deep-research-report1.md SHA256 BA705626D31A8F157896A28381F68B97C13928582B0BD4B1E3E09639D92EC0F3 recommends rights-first metadata and ingestion lanes. |
