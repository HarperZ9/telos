...
- Telos catalog now presents 66 available tools across the five flagships, including `telos.context.pack`, `telos.model.foundry`, `telos.learning.forge`, `telos.learning.labs`, `telos.mcp.freshness`, `telos.ci.doctor`, `telos.ci.triage`, `telos.presentation.doctor`, `telos.accessibility.doctor`, `telos.performance.doctor`, `telos.compatibility.doctor`, `telos.operator.doctor`, `telos.research.thermodynamic`, `telos.second_level.queue`, `telos.workstation.substrate`, `telos.native.control`, `telos.browser.evidence`, `telos.showcase.scout`, and `telos.proof`.
