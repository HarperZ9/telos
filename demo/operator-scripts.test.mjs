...
assert.match(status.native.current_status, /29-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+29 total, 29 available/);
assert.match(catalogSummary.stdout, /telos\s+11 tools\s+telos.status, telos.doctor/);
