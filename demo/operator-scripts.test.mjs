...
assert.match(status.native.current_status, /25-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+25 total, 25 available/);
assert.match(catalogSummary.stdout, /telos\s+7 tools\s+telos.status, telos.doctor/);
