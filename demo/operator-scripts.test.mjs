...
assert.match(status.native.current_status, /28-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+28 total, 28 available/);
assert.match(catalogSummary.stdout, /telos\s+10 tools\s+telos.status, telos.doctor/);
