...
assert.match(status.native.current_status, /27-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+27 total, 27 available/);
assert.match(catalogSummary.stdout, /telos\s+9 tools\s+telos.status, telos.doctor/);
