...
const payload = actionEnvelope({
  ...
  native: {
    ...
    current_status: "0.3.0 source registry package with 69-tool five-flagship catalog, CI doctor, CI triage, presentation doctor, accessibility doctor, performance doctor, compatibility doctor, operator doctor, context envelopes, context packs, action receipts, loop ledger, objective monitoring, model foundry, Learning Forge, executable Learning Forge labs, OSS Proof Showcase scout, agent-action proof packets, research-claim proof packets, visual-truth proof packets, build scientific-runtime proof packets, MCP freshness, research seeds, transcript-backed thermodynamic research, rendering research, rendering capabilities, measurement layers, creative engine, creative kernels, revival registry, second-level queue, workstation substrate, display calibration, native control of browser and apps, metadata-bound control receipts, unredacted browser evidence packets, and native Telos MCP surface"
  },
  nextActions: [
    {
      tool: "index",
