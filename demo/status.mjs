...
const payload = actionEnvelope({
  ...
  native: {
    ...
    current_status: "source demo with 33-tool five-flagship catalog, context envelopes, action receipts, loop ledger, research seeds, rendering research, rendering capabilities, measurement layers, creative engine, and native Telos MCP surface"
  },
  nextActions: [
    {
      tool: "index",
