...
assert.match(statusPayload.native.current_status, /52-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+52 total, 52 available/);
assert.match(catalogSummary.stdout, /telos\s+24 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+52 expected/);
