...
assert.match(statusPayload.native.current_status, /55-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+55 total, 55 available/);
assert.match(catalogSummary.stdout, /telos\s+27 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+55 expected/);
