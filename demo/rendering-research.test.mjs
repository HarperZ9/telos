...
assert.match(statusPayload.native.current_status, /69-tool/);
...
assert.match(catalogSummary.stdout, /telos\s+41 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+69 expected/);
