...
assert.match(statusPayload.native.current_status, /64-tool/);
...
assert.match(catalogSummary.stdout, /telos\s+36 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+64 expected/);
