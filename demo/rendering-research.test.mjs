...
assert.match(statusPayload.native.current_status, /53-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+53 total, 53 available/);
assert.match(catalogSummary.stdout, /telos\s+25 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+53 expected/);
