...
assert.match(statusPayload.native.current_status, /54-tool/);
...
assert.match(catalogSummary.stdout, /tools\s+54 total, 54 available/);
assert.match(catalogSummary.stdout, /telos\s+26 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+54 expected/);
