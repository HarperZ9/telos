...
assert.match(statusPayload.native.current_status, /49-tool/);
...
assert.match(catalogSummary.stdout, /telos\s+21 tools/);
...
assert.match(manifestSummary.stdout, /tools\s+49 expected/);
