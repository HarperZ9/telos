...
- **Dogfood research lane:** latest proof-packet passes include BuildLang source/context/runtime receipts and a visual-truth packet that binds Build Color software metrics, market gaps, negative calibration boundaries, Gather docs, Forum routing, and Crucible verdicts under `docs/research/dogfood/`. The current BuildLang check packet is [`docs/research/dogfood/packets/102-buildlang-check-receipt-adapter.md`](docs/research/dogfood/packets/102-buildlang-check-receipt-adapter.md), the current YouTube-to-BuildLang compounding map is [`docs/research/dogfood/packets/103-youtube-buildlang-megatool-bridge.md`](docs/research/dogfood/packets/103-youtube-buildlang-megatool-bridge.md), the current executable optimization workflow is [`docs/research/dogfood/packets/104-quantum-optimization-workflow-receipt.md`](docs/research/dogfood/packets/104-quantum-optimization-workflow-receipt.md), the current BuildLang-native optimization source proof is [`docs/research/dogfood/packets/105-buildlang-native-optimization-kernel-receipt.md`](docs/research/dogfood/packets/105-buildlang-native-optimization-kernel-receipt.md), the current YouTube-bound growth-vector scorecard is [`docs/research/dogfood/packets/106-youtube-field-growth-vector-scorecard.md`](docs/research/dogfood/packets/106-youtube-field-growth-vector-scorecard.md), the current BuildLang optimization proof workbench is [`docs/research/dogfood/packets/107-buildlang-optimization-proof-workbench.md`](docs/research/dogfood/packets/107-buildlang-optimization-proof-workbench.md), the current solver-branch interop schema is [`docs/research/dogfood/packets/108-solver-branch-receipt-interop-schema.md`](docs/research/dogfood/packets/108-solver-branch-receipt-interop-schema.md), the current OR-Tools executed branch receipt is [`docs/research/dogfood/packets/109-ortools-branch-execution-receipt.md`](docs/research/dogfood/packets/109-ortools-branch-execution-receipt.md), and the current Ocean/dimod local BQM branch receipt is [`docs/research/dogfood/packets/110-ocean-dimod-bqm-branch-receipt.md`](docs/research/dogfood/packets/110-ocean-dimod-bqm-branch-receipt.md).
- **Latest solver-proof correction:** [`docs/research/dogfood/packets/111-inequality-safe-bqm-receipt.md`](docs/research/dogfood/packets/111-inequality-safe-bqm-receipt.md) records a bounded counterexample where an equality-to-capacity BQM penalty selects an infeasible knapsack solution, then records a slack-variable repair. It is a law candidate and regression fixture, not a promoted natural law.
- **Latest YouTube-driven roadmap:** [`docs/research/dogfood/packets/112-youtube-critical-data-megatool-roadmap.md`](docs/research/dogfood/packets/112-youtube-critical-data-megatool-roadmap.md) binds the supplied 19-video corpus to the current optimization proof stack and makes `constraint_encoding_receipt` the next solver-branch integration requirement.
- **Latest solver integration adapter:** [`docs/research/dogfood/packets/113-constraint-encoding-receipt-adapter.md`](docs/research/dogfood/packets/113-constraint-encoding-receipt-adapter.md) turns that requirement into branch-level receipts and promotion-blocks the executed Ocean/dimod BQM branch until slack or inequality encoding is explicit.
- **Latest AI4Science lane:** [`docs/research/dogfood/packets/114-ai4science-claim-to-experiment-receipt.md`](docs/research/dogfood/packets/114-ai4science-claim-to-experiment-receipt.md) maps FutureHouse, Sakana AI Scientist, Microsoft Discovery, BioNeMo, AlphaFold 3, Nextflow, Snakemake, and Benchling into a minimum claim-to-experiment proof packet.
- **Latest equation proof:** [`docs/research/dogfood/packets/115-reaction-mass-conservation-receipt.md`](docs/research/dogfood/packets/115-reaction-mass-conservation-receipt.md) proves and probes a closed first-order reaction invariant, records an open-system negative fixture, and keeps the result at `LAW_CANDIDATE`.
- **Latest AI4Science invariant checker:** [`docs/research/dogfood/packets/116-stoichiometric-invariant-checker-receipt.md`](docs/research/dogfood/packets/116-stoichiometric-invariant-checker-receipt.md) derives `A+B+C` from a stoichiometric left-nullspace vector, binds the YouTube roadmap as source signal, and rejects a leaky open-system fixture.
- **Latest reaction-network corpus harness:** [`docs/research/dogfood/packets/117-reaction-network-corpus-harness-receipt.md`](docs/research/dogfood/packets/117-reaction-network-corpus-harness-receipt.md) scales the invariant checker to four network cases, records one expected open-system rejection, and binds the next BuildLang chemistry-kernel receipt target without claiming it has compiled yet.
- **Latest stochastic proof lane:** [`docs/research/dogfood/packets/118-detailed-balance-markov-receipt.md`](docs/research/dogfood/packets/118-detailed-balance-markov-receipt.md) proves a bounded detailed-balance-to-stationarity identity for finite Markov kernels, maps the MCMC/probabilistic-runtime market surface, and records both row-stochastic and non-reversible boundary fixtures.
- **Latest stochastic corpus harness:** [`docs/research/dogfood/packets/119-stochastic-kernel-corpus-harness-receipt.md`](docs/research/dogfood/packets/119-stochastic-kernel-corpus-harness-receipt.md) turns that Markov proof into four kernel/source-boundary cases, binds the 19-video YouTube roadmap as source-lead architecture data, and defines the minimum sampler-adapter receipt fields for future probabilistic runtime work.
- **Latest stochastic runtime receipt:** [`docs/research/dogfood/packets/120-stochastic-runtime-chain-receipt.md`](docs/research/dogfood/packets/120-stochastic-runtime-chain-receipt.md) instantiates the sampler-adapter fields as a finite-chain runtime receipt with target/kernel digests, seed, warmup, exact and empirical diagnostics, negative fixtures, and an explicit BuildLang target-not-compiled boundary.
- **Latest multi-kernel runtime suite:** [`docs/research/dogfood/packets/121-multi-kernel-runtime-suite-receipt.md`](docs/research/dogfood/packets/121-multi-kernel-runtime-suite-receipt.md) runs the same adapter interface across reversible MATCH, row-stochastic drift, and stationary non-reversible boundary kernels, preserving the 19-video YouTube source-lead binding.
- **Latest control certificate lane:** [`docs/research/dogfood/packets/122-lyapunov-stability-certificate-receipt.md`](docs/research/dogfood/packets/122-lyapunov-stability-certificate-receipt.md) proves an exact rational discrete-time Lyapunov identity, records unstable and bad-certificate fixtures, and maps control/MPC/robotics source anchors for future autonomy proof packets.
- **Latest YouTube-critical control packet:** [`docs/research/dogfood/packets/123-constrained-mpc-feasibility-receipt.md`](docs/research/dogfood/packets/123-constrained-mpc-feasibility-receipt.md) turns the 19-video YouTube roadmap into exact constrained-MPC rollout, infeasibility, bad-plan, and receipt-field requirements while keeping video claims as source leads.
- **Latest multi-domain optimization suite:** [`docs/research/dogfood/packets/124-multi-domain-constrained-optimization-suite.md`](docs/research/dogfood/packets/124-multi-domain-constrained-optimization-suite.md) runs one receipt schema across warehouse, robotics quality, safety-allocation, and quant risk-budget toy fixtures with four negative witnesses and 12 market/source anchors.
- **Latest solver-branch replay adapter:** [`docs/research/dogfood/packets/125-solver-branch-replay-adapter.md`](docs/research/dogfood/packets/125-solver-branch-replay-adapter.md) replays the four optimization fixtures through deterministic local and SciPy HiGHS branches, fences unavailable OR-Tools/PuLP branches, and binds four new YouTube links as Gather-verified source leads without promoting their claims.
- **Latest formal/physics bridge:** [`docs/research/dogfood/packets/126-formal-physics-source-lead-bridge.md`](docs/research/dogfood/packets/126-formal-physics-source-lead-bridge.md) turns those four new source leads into bounded requirements for formal math, Born-rule normalization, counterexample revision, and loop replay receipts, with all video-derived requirements held at `HYPOTHESIS`.
- **Latest theorem-prover adapter:** [`docs/research/dogfood/packets/127-theorem-prover-adapter-receipt.md`](docs/research/dogfood/packets/127-theorem-prover-adapter-receipt.md) declares Lean-style finite category theorem targets, verifies them with a Python finite-model replay, and fences missing Lean/Rocq/Isabelle/Agda execution.
- **Latest formal target package:** [`docs/research/dogfood/packets/128-formal-target-packaging-receipt.md`](docs/research/dogfood/packets/128-formal-target-packaging-receipt.md) emits Lean, Rocq, Isabelle, and Agda source artifacts plus a manifest while keeping parser/prover execution explicitly fenced.
- **Latest Hamiltonian proof lane:** [`docs/research/dogfood/packets/129-hamiltonian-symplectic-receipt.md`](docs/research/dogfood/packets/129-hamiltonian-symplectic-receipt.md) proves a scoped symplectic Euler modified-invariant law candidate, rejects an explicit-Euler area/energy negative fixture, and maps the scientific-compute market surface.
- **Latest Hamiltonian runtime bridge:** [`docs/research/dogfood/packets/130-hamiltonian-runtime-branch-receipt.md`](docs/research/dogfood/packets/130-hamiltonian-runtime-branch-receipt.md) replays that exact oracle through available NumPy and SciPy branches, records a negative explicit-Euler fixture, and fences missing BuildLang/buildc, JAX, and Julia execution branches.
- **Latest YouTube megatool strategy pass:** [`docs/research/dogfood/packets/131-youtube-megatool-growth-vector-receipt.md`](docs/research/dogfood/packets/131-youtube-megatool-growth-vector-receipt.md) refreshes the four latest video leads, derives transcript signal counts without storing raw transcripts, and ranks `scientific_runtime_receipt_layer` as the primary 30-day push across BuildLang/buildc, Telos, Crucible, and measurement truth kits.
- **Latest scientific runtime layer:** [`docs/research/dogfood/packets/132-scientific-runtime-receipt-layer-spec.md`](docs/research/dogfood/packets/132-scientific-runtime-receipt-layer-spec.md) maps 17 official runtime/prover/telemetry/lineage source anchors into an eight-field receipt contract and strengthens the Hamiltonian lane with exact symplectic residual checks plus 24,000-step float drift receipts.
- **Latest field-to-proof factory:** [`docs/research/dogfood/packets/133-field-to-proof-packet-factory.md`](docs/research/dogfood/packets/133-field-to-proof-packet-factory.md) packages the ecosystem as six proof-packet factories across agent ops, formal research, AI4Science, scientific runtime/color, workflow/lab handoff, and literature graphs, with 18 Gather source anchors and a negative fixture rejecting packets missing verifier and negative-result lanes.
- **Latest agent-action factory adapter:** [`docs/research/dogfood/packets/134-agent-action-proof-packet-factory-adapter.md`](docs/research/dogfood/packets/134-agent-action-proof-packet-factory-adapter.md) turns the top-ranked factory into an executable adapter: five incumbent-style trace inputs become Telos action receipts with authority/admission/side-effect/verifier fields, while four negative fixtures reject missing authority, admission, verifier, external-write, and hidden-reasoning violations.
- **Latest YouTube experiment router:** [`docs/research/dogfood/packets/135-youtube-experiment-router.md`](docs/research/dogfood/packets/135-youtube-experiment-router.md) refreshes the four latest video receipts and routes them into falsifiable experiments, ranking `cross_field_scientific_runtime_router` first while keeping every video-derived claim at `SOURCE_LEAD_ONLY`.
- **Latest source-lead demotion gate:** [`docs/research/dogfood/packets/136-source-lead-demotion-gate.md`](docs/research/dogfood/packets/136-source-lead-demotion-gate.md) makes the video-source boundary executable: source leads and hypotheses pass, independently evidenced probe claims pass, and video-only fact/law promotion, raw transcripts, and keyword-count proof misuse are rejected.
- **Latest cross-field runtime router:** [`docs/research/dogfood/packets/137-cross-field-scientific-runtime-router.md`](docs/research/dogfood/packets/137-cross-field-scientific-runtime-router.md) routes one quantum-source lead through the demotion gate into a bounded exact-oracle plus Python runtime normalization receipt while rejecting interpretation, market-fit, and missing-normalization promotion.
- **Latest cross-field proof suite:** [`docs/research/dogfood/packets/138-cross-field-proof-suite.md`](docs/research/dogfood/packets/138-cross-field-proof-suite.md) expands the router into formal-math, physics-runtime, optimization, and counterexample-revision fixtures with Gather source receipts, negative controls, and Crucible verification while keeping natural-law and market-fit claims unpromoted.
- **Latest functional-learning digest:** [`docs/research/dogfood/packets/139-brandom-functional-learning-digest.md`](docs/research/dogfood/packets/139-brandom-functional-learning-digest.md) catalogs supplied Robert Brandom sources into topic signals, derivation anchors, scorekeeping-learning fixture, and tool hypotheses while rejecting raw transcript dumps, blocked-profile evidence, and product claims without task receipts.
- **Latest work/lesson graph:** [`docs/research/dogfood/packets/140-brandom-work-lesson-graph.md`](docs/research/dogfood/packets/140-brandom-work-lesson-graph.md) catalogs five Brandom downloadable texts/course pages into a source-backed work catalog and six-node lesson graph while rejecting PDF body export, complete-bibliography, learning-efficacy, and natural-law claims.
- **Latest tradition atlas:** [`docs/research/dogfood/packets/141-tradition-derivation-atlas.md`](docs/research/dogfood/packets/141-tradition-derivation-atlas.md) maps 10 source-backed philosophy anchors into 13 bounded prerequisite/contrast edges, five learning modules, and four product hypotheses while rejecting complete-genealogy, causal-influence, learning-efficacy, raw-export, and natural-law overclaims.
- **Latest proof transfer:** [`docs/research/dogfood/packets/142-proof-pattern-transfer.md`](docs/research/dogfood/packets/142-proof-pattern-transfer.md) transfers source-trace and overclaim-audit structure into a bounded skew-generator norm-invariant packet with two positive fixtures, two counterexamples, and a `LAW_CANDIDATE` that remains explicitly unpromoted.
- **Latest YouTube source-lead intake:** [`docs/research/dogfood/packets/143-youtube-source-lead-intake.md`](docs/research/dogfood/packets/143-youtube-source-lead-intake.md) ingests the supplied videos into 19 verified metadata, transcript, and channel-page receipts, routes nine videos across four source-lead lanes, and rejects video-only facts, transcript ground truth, market claims, and law promotion.
- **Latest all-video author index:** [`docs/research/dogfood/packets/144-all-video-author-theory-index.md`](docs/research/dogfood/packets/144-all-video-author-theory-index.md) normalizes 54 locally recoverable video leads and five channel sources into 33 author nodes, nine theory lanes, and 33 reference-expansion rows, while rejecting title-as-authority, channel-as-complete-corpus, raw transcript export, unsourced references, and natural-law promotion.
- **Latest wide research substrate:** [`docs/research/dogfood/packets/145-bio-med-robotics-nomenclature-map.md`](docs/research/dogfood/packets/145-bio-med-robotics-nomenclature-map.md) maps 32 current source receipts across biology, medicine, robotics, and 12 archive/database substrates into 14 domain expansion queues, eight terminology bridges, and five product hypotheses, while rejecting blocked-source, demo, market, nomenclature, and natural-law overclaims.
- **Latest SAIR source-lead pass:** [`docs/research/dogfood/packets/146-sair-math-research-infrastructure-source-leads.md`](docs/research/dogfood/packets/146-sair-math-research-infrastructure-source-leads.md) captures the supplied SAIR site, channel, and Terence Tao competition video plus official competition/GitHub anchors into a math research infrastructure packet for competition proof packets, Lean certificate receipts, exact-reasoning harnesses, and BuildLang/buildc adapter experiments.
- **Latest competition proof-packet fixture:** [`docs/research/dogfood/packets/147-sair-stage1-competition-proof-packet.md`](docs/research/dogfood/packets/147-sair-stage1-competition-proof-packet.md) turns the SAIR Stage 1-style math-distillation lead into a local `CompetitionProofPacket` fixture with four equation-implication tasks, verdict parsing, six rejected negative controls, zero external model calls, and no promoted theorem or leaderboard claim.
- **Latest public judge adapter:** [`docs/research/dogfood/packets/148-sair-stage1-judge-repo-adapter.md`](docs/research/dogfood/packets/148-sair-stage1-judge-repo-adapter.md) binds the public SAIR Stage 1 judge repository at HEAD `fe00cf9e9080dba6634882c9316b73d536c4fe60`, runs its local no-secret command surface, records 15 file hashes, rejects six overclaim fixtures, and fences hosted model calls behind future action receipts.
- **Latest Lean certificate preflight:** [`docs/research/dogfood/packets/149-sair-stage2-lean-certificate-preflight.md`](docs/research/dogfood/packets/149-sair-stage2-lean-certificate-preflight.md) binds the public SAIR Stage 2 Lean repository at HEAD `6805e2323018fbd8a85f41ca09fc33d74d5a02a5`, records the `leanprover/lean4:v4.30.0-rc2` toolchain pin, compiles the Python surface, and keeps Lean replay fenced as `UNVERIFIABLE_TOOL_UNAVAILABLE` until `lean/lake/elan` are available.
- **Latest research archive substrate atlas:** [`docs/research/dogfood/packets/150-research-archive-substrate-atlas.md`](docs/research/dogfood/packets/150-research-archive-substrate-atlas.md) maps 30 first-wave archive/API/repository systems into 14 substrate families, 18 domain expansion queues, six megatool routes, and ten adapter requirements, while keeping source correctness, publication validity, theorem proof, experiment truth, and natural-law promotion explicitly out of scope.
- **Latest SAIR Foundation refresh:** [`docs/research/dogfood/packets/151-sair-foundation-refresh.md`](docs/research/dogfood/packets/151-sair-foundation-refresh.md) binds the new SAIR Foundation links, competition `llms.txt` shadows, one Tao video transcript receipt, and 12 channel leads to current Gather 1.5.0, Index 2.8.0, Forum 1.12.0, Crucible 1.1.0, Telos 0.1.0, and yt-dlp 2026.06.09 experiment routes.
- **Latest source-registry federation:** [`docs/research/dogfood/packets/152-source-registry-federation.md`](docs/research/dogfood/packets/152-source-registry-federation.md) expands the research substrate toward registry-scale intake with 33 source rows, 10 registry layers, 15 adapter requirements, eight world-problem workbenches, and first implementation targets for `RepositoryDirectoryAdapter` and `ScholarlyGraphAdapter`.
- **Latest registry adapter contracts:** [`docs/research/dogfood/packets/153-registry-adapter-contracts.md`](docs/research/dogfood/packets/153-registry-adapter-contracts.md) turns that registry substrate into two replayable adapter contracts, 14 contract fixtures, 15 join keys, 10 negative fixtures, updated-tool-floor receipts, and a first `one_institution_claim_graph` workbench.
- **Latest one-institution claim graph:** [`docs/research/dogfood/packets/154-one-institution-claim-graph.md`](docs/research/dogfood/packets/154-one-institution-claim-graph.md) dogfoods the adapter contracts against MIT with 11 Gather captures, ROR/OpenAlex identity join, MIT DSpace OAI-PMH endpoint and record samples, Crossref affiliation metadata, DataCite source-lead fencing, and Crucible verification.
- **Latest multi-institution claim graph:** [`docs/research/dogfood/packets/155-multi-institution-claim-graph.md`](docs/research/dogfood/packets/155-multi-institution-claim-graph.md) replays the institution adapter across MIT, Harvard, Cornell, and Caltech with 18 Gather captures, four ROR/OpenAlex identity joins, four repository OAI-PMH `Identify` joins, three Crossref affiliation joins, preserved rate-limit and endpoint-drift warnings, and Crucible verification.
- **Latest source-adapter retry policy:** [`docs/research/dogfood/packets/156-adapter-retry-policy.md`](docs/research/dogfood/packets/156-adapter-retry-policy.md) turns Crossref, OpenAlex, ROR, OAI-PMH, HTTP, and Index source-policy evidence into 12 retry/fallback/promotion rules, so 429s, 503s, stale endpoints, resumption-token failures, and selector drift become typed receipts instead of false absence claims.
- **Latest policy-aware institution queue:** [`docs/research/dogfood/packets/157-policy-aware-institution-queue.md`](docs/research/dogfood/packets/157-policy-aware-institution-queue.md) replays the institution adapter over ETH Zurich, University of Tokyo, University of Cape Town, and Universidade de Sao Paulo with 16 live source captures, ranked ROR/OpenAlex identity joins, OAI endpoint-drift warnings, Crossref sample-only evidence, and Crucible verification.
- **Latest live source-router probes:** [`docs/research/dogfood/packets/158-live-source-router-probes.md`](docs/research/dogfood/packets/158-live-source-router-probes.md) tests 25 live/fallback routes across archive, preprint, scholarly graph, biomedical, repository-directory, college repository, and research-data surfaces with 30 Gather captures, retryable endpoint warnings, current tool-floor receipts, and Crucible verification.
- **Latest cross-domain substrate expansion:** [`docs/research/dogfood/packets/159-cross-domain-substrate-expansion.md`](docs/research/dogfood/packets/159-cross-domain-substrate-expansion.md) queues 131 candidate substrates across 16 source families and 49 domain labels, with 39 official-source capture attempts, 12 workbench lanes, explicit warning policies, and Crucible verification.
- **Latest mixed-source science proof packet:** [`docs/research/dogfood/packets/160-mixed-source-protein-proof-packet.md`](docs/research/dogfood/packets/160-mixed-source-protein-proof-packet.md) replays the protein-design-lab lane over UniProt, AlphaFold DB, RCSB PDB, Europe PMC, PubMed, and local sequence checks, with 5 Gather-verified source bodies, 7 matched verifier checks, 3 explicit overclaim warnings, and Crucible verification.
- **Latest source-federation wind-down:** [`docs/research/dogfood/packets/161-frontier-problem-source-federation.md`](docs/research/dogfood/packets/161-frontier-problem-source-federation.md) closes the broad source-expansion phase with 83 candidate sources, 15 source families, 40 domains, 24 Gather-verified captures, 12 problem lanes, 8 admission gates, and Crucible verification.
- **Research wind-down synthesis:** [`docs/research/PROJECT-TELOS-RESEARCH-WINDDOWN-2026-07-02.md`](docs/research/PROJECT-TELOS-RESEARCH-WINDDOWN-2026-07-02.md) summarizes the 150-ledger dogfood corpus, capstone receipts, what is proven, what remains fenced, and the handoff from recon to packaging.
- **Run corpus manifest:** [`docs/research/PROJECT-TELOS-RUN-CORPUS-MANIFEST-2026-07-02.md`](docs/research/PROJECT-TELOS-RUN-CORPUS-MANIFEST-2026-07-02.md) preserves the pass-by-pass ledger index used by the wind-down package.
- **Master plan:** [`docs/PROJECT-TELOS-MASTER-PLAN-2026-07-02.md`](docs/PROJECT-TELOS-MASTER-PLAN-2026-07-02.md) turns Gather, Index, Forum, Crucible, Telos, Learn, BuildLang/buildc, and Emet into the proof-native model-building operating system.
- **Master plan roadmap:** [`docs/PROJECT-TELOS-MASTER-PLAN-ROADMAP-2026-07-02.md`](docs/PROJECT-TELOS-MASTER-PLAN-ROADMAP-2026-07-02.md) carries the product surfaces, 30/60/90/180-day plan, public demos, operating rules, and success metrics.
- **Updated tool-shape assessment:** [`docs/TOOLING-SHAPE-ASSESSMENT-2026-07-02.md`](docs/TOOLING-SHAPE-ASSESSMENT-2026-07-02.md) records the current 70-tool Telos catalog, installed flagship versions, local Learn/Build/Emet surfaces, and packaging gaps after the updated-tool pass.
- **Parallel Codex handoff package:** [`docs/outreach/PARALLEL-CODEX-HANDOFF-2026-07-02.md`](docs/outreach/PARALLEL-CODEX-HANDOFF-2026-07-02.md) points the posting session at demo packages, outreach briefs, visibility copy, evidence commands, and no-overclaim boundaries.
